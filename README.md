...
```sh
  cd my-folder
  git@github.com:Mutai-Gilbert/budget-app.git
```
...
- GitHub: [@Mutai-Gilbert](https://github.com/Mutai-Gilbert/budget-app)
...
Feel free to check the [issues page](https://github.com/Mutai-Gilbert/budget-app).
